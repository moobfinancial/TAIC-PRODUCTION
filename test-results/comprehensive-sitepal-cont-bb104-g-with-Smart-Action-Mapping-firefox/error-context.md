...
- main:
  ...
  - img
  - img
  - paragraph: Retrying avatar connection...
  - paragraph: Avatar loading is taking longer than expected. The service may be experiencing high traffic.
  - button "Retry Connection (3 attempts left)"
